...
pub fn bench_bn254_field_arith(c: &mut Criterion) {
    let mut g = c.benchmark_group("BN254/Microbenchmarks");
...
pub fn bench_bn254_scalar_mul(c: &mut Criterion) {
    let mut g = c.benchmark_group("BN254/Microbenchmarks");
...
pub fn bench_bn254_group_add(c: &mut Criterion) {
    let mut g = c.benchmark_group("BN254/Microbenchmarks");
...
pub fn bench_bn254_pairing_eval(c: &mut Criterion) {
    let mut g = c.benchmark_group("BN254/Microbenchmarks");
...
pub fn bench_bn254_commit_group_scalar_mul(c: &mut Criterion) {
    let mut g = c.benchmark_group("BN254/Microbenchmarks");
...
pub fn bench_bn254_commit_group_add(c: &mut Criterion) {
    let mut g = c.benchmark_group("BN254/Microbenchmarks");
...
pub fn bench_bn254_commit_group_pairing_eval(c: &mut Criterion) {
    let mut g = c.benchmark_group("BN254/Microbenchmarks");
...
pub fn bench_bn254_commit(c: &mut Criterion) {
    let mut g = c.benchmark_group("BN254/Microbenchmarks");
...
criterion_group! {
    ...
    targets =
        bench_bn254_commit_group_scalar_mul,
        bench_bn254_commit_group_add,
        bench_bn254_commit_group_pairing_eval,
        bench_bn254_commit,
}

criterion_main!(bn254_bilinear_group_arith, bn254_pairing, bn254_commit);
